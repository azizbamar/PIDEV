...
class AdminController extends AbstractController
{
    ...
    #[Route('/prescription/{id}', name: 'app_prescription_show_dashboard', methods: ['GET'])]
    ...
    #[Route('/prescription/{id}/edit', name: 'app_prescription_edit_dashboard', methods: ['GET', 'POST'])]
    ...
    #[Route('/medical/sheet/{id}/edit', name: 'app_medical_sheet_edit_dashboard', methods: ['GET', 'POST'])]
