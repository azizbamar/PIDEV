...
#[ORM\Entity(repositoryClass: ContratHabitatRepository::class)]
class ContratHabitat extends ContratAssurance
{
    ...
    #[Assert\NotBlank(message: 'Les détails du contrat sont obligatoire')]
